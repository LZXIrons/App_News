...
//var appData = require('../static/yule.json')
//var searchData = require('../static/search.json')
//var yule = appData.data
//var search = searchData.data

//var apiRoutes = express.Router()

//apiRoutes.get('/yule.json', function (req, res) {
//  res.json({
//    data: yule
//  });
//})

//apiRoutes.get('/search.json', function (req, res) {
//  res.json({
//    data: search
//  });
//})
