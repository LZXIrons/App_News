    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="media_name">
                <img class="media_img" src="../../common/img/男头像.png">
                <p class="media_text">
            ...
            <div class="zan">
                <div class="zan_wrapper">
                    <mt-button size="normal" class="zan_button">
                        <img src="../../common/img/赞.png" />
                        {{repin_count}}
                    </mt-button>
                    <mt-button size="normal" class="zan_button">
                        <img src="../../common/img/踩.png" />
                         不喜欢
                    </mt-button>
                </div>    
            </div>
        ...
        <foot_act>
            <div class="foot_act" slot="foot_act">
                <div class="input_wrapper">
                    ...
                    <img src="../../common/img/笔记.png" width="20px" />
                </div>
                 <div class="comment_mes " @click="sorry" >
                     <img src="../../common/img/消息中心.png" width="25" height="25" />    
...
export default {
    data(){
        return{
            ...
            abstract:this.$route.params.abstract,
            image_list:this.$route.params.image_list,
            repin_count:this.$route.params.repin_count,
            comment_count:this.$route.params.comment_count,
            keywords:this.$route.params.keywords*/
        }
    },
    created(){
      this.$store.commit(type.CHANGE_ROUTER,false)
    },
    components: {
        foot_act,
        share_box
